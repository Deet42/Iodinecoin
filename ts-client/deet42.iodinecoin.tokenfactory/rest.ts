...
/**
 * @title iodinecoin/tokenfactory/denom.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryDenomAll
   * @request GET:/Deet42/iodinecoin/tokenfactory/denom
   */
  queryDenomAll = (
    query?: {
    ...
    this.request<TokenfactoryQueryAllDenomResponse, RpcStatus>({
      path: `/Deet42/iodinecoin/tokenfactory/denom`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/Deet42/iodinecoin/tokenfactory/denom/{denom}
   */
  queryDenom = (denom: string, params: RequestParams = {}) =>
    this.request<TokenfactoryQueryGetDenomResponse, RpcStatus>({
      path: `/Deet42/iodinecoin/tokenfactory/denom/${denom}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/Deet42/iodinecoin/tokenfactory/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<TokenfactoryQueryParamsResponse, RpcStatus>({
      path: `/Deet42/iodinecoin/tokenfactory/params`,
      method: "GET",
      format: "json",
      ...params,
    });
